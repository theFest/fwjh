...
import com.fwjh.app.repository.TagsRepository;
...
/**
 * REST controller for managing {@link com.fwjh.app.domain.Tags}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TagsResource {
     ...
     */
    @GetMapping("/tags")
    public ResponseEntity<List<Tags>> getAllTags(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
