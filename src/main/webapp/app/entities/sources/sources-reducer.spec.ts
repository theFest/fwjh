...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sources.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOURCES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOURCES actions', async () => {
      const expectedActions = [
        {
